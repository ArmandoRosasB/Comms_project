...
#include <exception> //Clase especial de c++
#include <string>
#include <cstdio>

/*********** Exception ***********/
class Exception : public std::exception { //std::exception Permite mandar excepciones.
protected:
	std::string text;

public:
    //Syntaxis de la clase. Constructor mas destructor
	Exception() throw();
	~Exception() throw();
